...
@property (weak, nonatomic) IBOutlet UILabel *lblCountName;
@property (weak, nonatomic) IBOutlet UILabel *lblBindPhone;
...
- (void)viewDidLoad {
    ...
    self.headImage.layer.borderColor = [UIColor getImageBorderColor].CGColor;
